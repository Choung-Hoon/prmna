...
dhtmlxAjax=
{
	get:function(url,callback)
	{
		...
		t.waitCall=callback;t.loadXML(url)
 		return t
 	},
 ...
 if ((_isIE)&&(!this._retry))
 {
 	...
 	if(this.xmlDoc.responseText.indexOf("<?xml ") == -1 )
 	{
 	...
 	var oldObj = this.xmlDoc;this._retry=true;
 	this.xmlDoc=new ActiveXObject("Microsoft.XMLDOM");
 	this.xmlDoc.async=false;
 	
 	
 	this.xmlDoc["loadXM"+"L"](xmlString);return this.getXMLTopNode(tagName, oldObj)};dhtmlxError.throwError("LoadXML", "Incorrect XML", [
 (oldObj||this.xmlDoc),
 this.mainObject
 ]);return document.createElement("DIV")};
 ...
 dtmlXMLLoaderObject.prototype.doXPath=function(xpathExp, docObj, namespace, result_type)
 {
  ...
  //alert( "00000000000");
 	...
 	if (!docObj)if (!this.xmlDoc.nodeName)
 	{
 ...
 {var z = xpathExp.replace(/[\/]+/gi, "/").split('/');var obj = null;var i = 1;if (!z.length)return [];if (z[0] == ".")obj=[docObj];else if (z[0] == ""){obj=(this.xmlDoc.responseXML||this.xmlDoc).getElementsByTagName(z[i].replace(/\[[^\]]*\]/g, ""));i++}else
