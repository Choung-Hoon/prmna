...
<tr><td>
	...
	<tr>
	<td>cell spacing</td>
	<td><input type="text" name="cellspacing" value="0" style="width:50px" maxlength="4"></td>
	</tr>
	<tr>
	<td>cell padding</td>
	<td><input type="text" name="cellpadding" value="5" style="width:50px" maxlength="4"></td>
	</tr>
	</table>
	</fieldset>
