...
<table x:str border=1 cellpadding=1 cellspacing=0 width=720 style='border-collapse:
 ...
 <col class=xl65 width=77 style='width:54pt'>
 <col class=xl65 width=10 style='width:54pt'>
