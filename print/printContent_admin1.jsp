...
<%
	...
	/* 2014.03.01 6개 필드 값을 받아서 화면에 출력함*/
	//회사이름
	...
	System.out.println(" curAdminInfo.getUserid() : " + curAdminInfo.getUserid());
	
	cmpnNm  = curAdminInfo.getCmpnNm();		//회사이름
	cmpnUrl = curAdminInfo.getCmpnUrl();	//회사 URL
	cmpnAddr = curAdminInfo.getCmpnAddr();	//회사 주소
	cmpnZip = curAdminInfo.getCmpnZip();	//회사 ZIP
	cmpnFax = curAdminInfo.getCmpnFax();	//회사 FAX
	cmpnTel = curAdminInfo.getCmpnTel();	//회사 전화번호 
	userPhone = curAdminInfo.getUserPhone();//사용자 핸드폰
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=720 style='border-collapse:
 ...
 <tr height=66 style='height:49.5pt'>
  ...
  <td colspan=3 class=xl65 width=100 style='width:144pt' id="button">
 ...
 <tr height=25 style='height:18.75pt'>
  <td height=25 class=xl65 style='height:18.75pt'></td>
  <td colspan=8 class=xl76>핸드폰 : <%=userPhone%>, 팩스 : <%=cmpnFax%>, 전화 : <%=cmpnTel%></td>
