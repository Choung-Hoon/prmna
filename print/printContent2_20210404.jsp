...
<%
  ...
  String cmpnNm  = admin.getCmpnNm();		//회사이름
	String cmpnUrl = admin.getCmpnUrl();	//회사 URL
	String cmpnAddr = admin.getCmpnAddr();	//회사 주소
  String cmpnZip = admin.getCmpnZip();	//회사 ZIP
	String cmpnFax = admin.getCmpnFax();	//회사 FAX
	String cmpnTel = admin.getCmpnTel();	//회사 전화번호 
	String userPhone = admin.getUserPhone();//사용자 핸드폰
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=720 style='border-collapse:
 ...
 <tr height=66 style='height:49.5pt'>
  ...
  -->
  <td colspan=8 class=xl73 width=619 style='width:465pt'><%=cmpnNm%></td>
 ...
 <tr height=27 style='height:20.25pt'>
  ...
  <td colspan=8 class=xl74>(<%=cmpnUrl%>)</td>
 ...
 <tr height=25 style='height:18.75pt'>
  ...
  <!--
  <td colspan=12 class=xl75>주소 : 서울시 송파구 송파대로 36가길 23(송파동,301호) (1688-3880)</td>
  -->
  <td colspan=12 class=xl75>주소 : <%=cmpnAddr%>&nbsp;(<%=cmpnZip%>)</td>
 </tr>
 <tr height=25 style='height:18.75pt'>
  <td height=25 class=xl65 style='height:18.75pt'></td>
  <!--
  ...
  02-516-6852</td>
  -->
  <td colspan=12 class=xl76>핸드폰 : <%=userPhone%>, 팩스 : <%=cmpnFax%>, 전화 : <%=cmpnTel%></td>
...
<% if ("Y".equals(isChromeBrowser)) {%>
  <td colspan=2 class=xl75 >* 법&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;인 :</td>
<%
	} else {
%>
...
%>
 <tr height=27 style='height:20.25pt'>
  <td height=27 class=xl65 style='height:20.25pt'></td>
<% if ("Y".equals(isChromeBrowser)) {%>
  <td colspan=2 class=xl75>* 면&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;허 :</td>
<%
	} else {
%>
...
%>
 <tr height=27 style='height:20.25pt'>
  <td height=27 class=xl65 style='height:20.25pt'></td>
<% if ("Y".equals(isChromeBrowser)) {%>
  <td colspan=2 class=xl75 x:str="* 자     본       금   : ">* 자&nbsp;&nbsp;&nbsp본&nbsp;&nbsp;&nbsp;금 :</td>
<%
	} else {
%>
...
%>
 ...
 <tr height=27 style='height:20.25pt'>
  <td height=27 class=xl65 style='height:20.25pt'></td>
<% if ("Y".equals(isChromeBrowser)) {%>  
  <td colspan=2 class=xl75 >* 지&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>역 :</td>
<%
	} else {
%>
...
%> 
 ...
 <tr height=27 style='height:20.25pt'>
  <td height=27 class=xl65 style='height:20.25pt'></td>
<% if ("Y".equals(isChromeBrowser)) {%>  
  <td colspan=2 class=xl75>* 공제출자좌수 :</td>
<%
	} else {
%>
...
%>  
 ...
 <tr height=27 style='height:20.25pt'>
  <td height=27 class=xl65 style='height:20.25pt'></td>
<% if ("Y".equals(isChromeBrowser)) {%>  
  <td colspan=2 class=xl75>* 공제조합잔액 :</td>
<%
	} else {
%>
...
%> 
 ...
 <tr height=27 style='height:20.25pt'>
  <td height=27 class=xl65 style='height:20.25pt'></td>
<% if ("Y".equals(isChromeBrowser)) {%>
  <td colspan=2 class=xl75 x:str="* 협                 회  : ">* 협&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회 :</td>
<%
	} else {
%>
...
<% if ("Y".equals(isChromeBrowser)) {%>
  <td colspan=2 class=xl75 x:str="* 시   공    능    력  : ">* 시 공 능 력 :</td>
<%
	} else {
%>
...
%>	
 <tr >
  <td class=xl65 ></td>
  <td class=xl82><%=excelData.getF2()%></td>              <!-- 업종 -->
  <td class=xl71><%=excelData.getFstYr()%></td>
  <td class=xl71><%=excelData.getScndYr()%></td>
  <td class=xl71><%=excelData.getF10()%></td>
  <td class=xl71><%=excelData.getF11()%></td>
  <td class=xl71><%=excelData.getF12()%></td>
  <td class=xl71><%=excelData.getF13()%></td>
  <td class=xl71><%=excelData.getSumOf5yr()%></td>
  <td class=xl71><%=excelData.getF14()%></td>
  <td class=xl71><%=excelData.getF9()%></td>
   <td class=xl67></td>
 </tr>
 ...
 <tr class=xl67 height=42 style='height:31.5pt'>
  ...
  <td colspan=11 class=xl70><span style='mso-spacerun:yes'>&nbsp;</span><%=excelData.getF19()%> (억)</td>
 </tr>
 <tr height=5 >
 ...
 <tr height=22 style='height:16.5pt'>
  ...
  <td class=xl72 colspan=5 style='mso-ignore:colspan'>* 양도가는 수수료 및 등기이전 비용은 별도입니다.</td>
  <td colspan=10 class=xl65 style='mso-ignore:colspan'></td>
 </tr>
